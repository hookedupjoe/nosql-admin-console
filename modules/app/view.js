...
module.exports.configure = function configure(theConfig) {
    ...
    base.run = function (req, res, next) {
        ...
        return new Promise($.async(function (resolve, reject) {
            try {
                ...
                var tmpDB = $.appData.getDatabaseForView(tmpViewDetails);
    ...
    //====== End of Module / configure ==== Nothing new below this
